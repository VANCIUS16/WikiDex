package com.example.wikidex40.ui.pokeinfo

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import androidx.lifecycle.Observer
import androidx.lifecycle.ViewModelProvider
import com.example.wikidex40.R
...
class PokeInfoActivity : AppCompatActivity() {
    ...
    private fun initUI(){
        ...
        viewModel.pokemonInfo.observe(this, Observer { pokemon ->
            nameTextView.text = "Nombre del Pokemon: ${pokemon.name}"
            heightText.text = "Altura del Pokemon: ${pokemon.height/10.0}M"
            weightText.text = "Peso del Pokemon: ${pokemon.weight/10.0}KG"
