package com.example.wikidex40.ui.pokelist

import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.example.wikidex40.model.api.PokeApiResponse
import com.example.wikidex40.model.api.PokeResult
import com.example.wikidex40.service.PokeApiService
    ...
    fun getPokemonList(){
        ...
        call.enqueue(object : Callback<PokeApiResponse>{
            override fun onResponse(call: Call<PokeApiResponse>,response: Response<PokeApiResponse>) {
                response.body()?.results?.let { list -> pokemonList.postValue(list) }
            }
            override fun onFailure(call: Call<PokeApiResponse>, t: Throwable) { call.cancel() }
        })
    }
}